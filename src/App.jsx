...
<>
  <div className='h-full w-full bg-[#DBDADE]'>
    <div className='hidden md:block fixed top-0 xl:left-102
    left-23 w-[90%] lg:left-65 lg:w-[80%] xl:w-[86.5%]  transparent z-50'>
          <Topbar/>
          </div> 
          <div className="md:fixed sticky" ><Sidebar /></div>
    ...
    <div className='md:flex'>
      ...
      <div className='md:w-full  h-full bg-[#DBDADE] md:px-2'> 
       ...
       <div className='w-full  h-[100%] md:pt-[65px] grid xl:grid-cols-10 md:grid-cols-9  xl:pt-[145px]   '>
        <div className='xl:col-span-7 col-span-6 h-full  '>
          <div className='grid h-full grid-rows-3 gap-2 md:p-2 md:mt-4 lg:mt-11'>
            ...
            <div className='xl:row-span-3  grid grid-cols-2 gap-2 md:h-[500px] lg:h-[700px] md:mt-[-140px] lg:mt-0 '>
            <div className='col-span-1  h-full rounded-xl'><SummaryChart/></div>
            <div className='col-span-1  h-full rounded-xl'><OrderVol/></div>
            <div className='
            col-span-2  w-full
            grid grid-col-5 '>
              <div className='col-span-1 bg-white flex justify-between items-center lg:mt-5 xl:rounded-t-lg md:rounded-t-sm 
               '>
                <div className='lg:text-4xl font-bold text-lg xl:p-10 p-2  md:py-4 lg:py-0 '>
                  <h1>Announcements</h1>
                </div>
                <div className='flex md:mr-1 lg:mr-0'>
                  <SearchBar/>
                  <EllipsisVertical className='lg:block hidden' size={64} color='#6F6B7D' />
                </div>
              </div>
              <div className='col-span-1 bg-white'>
                <div className='border-t-2 border-[#979797] lg:h-[740px] md:w-[428px] md:h-[467px] lg:w-full xl:rounded-b-lg md:rounded-b-sm '>
                  <MassageList/>
                </div>
              </div>
            </div>
       ...
       <div className='w-screen md:w-[98%] h-[100%] bg-amber-700g  '>
        <div className=' px-3 mt-[-40px] font-semibold '>
          <h2>Promotions</h2>
        </div>
        <PromotionSlider />
        <div className='grid grid-cols-2 grid-rows-2 h-[600px] w-[95%]
        mx-auto gap-2 mt-8'>
          <PendingOrdersChart/>
            <BestSelling />
            <Demo />
